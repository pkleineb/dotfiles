...
ln -fs "$getWall" "$ConfDir/awww/wall.set"
ln -fs "$cacheDir/${ThemeSet}/${getName}.rofi" "$ConfDir/awww/wall.rofi"
ln -fs "$cacheDir/${ThemeSet}/${getName}.blur" "$ConfDir/awww/wall.blur"
"${ScrDir}/awwwallpaper.sh"
